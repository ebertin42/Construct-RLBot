...
def collect_states(champion_ck, n_states, arenas=8, seed=11, device="cpu") -> dict:
    ...
    # The states are generated BY this checkpoint, so the engine has to be the
    # one it decodes with -- schema_version is 1 for both v1 tables and cannot
    # say which. The weights' own buffer can.
